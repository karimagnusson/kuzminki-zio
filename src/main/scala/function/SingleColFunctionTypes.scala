...
trait BigDecimalFunctionSingle extends SingleColFunction with BigDecimalCol
...
trait TimeFunctionSingle extends SingleColFunction with TimeCol

trait DateFunctionSingle extends SingleColFunction with DateCol

trait TimestampFunctionSingle extends SingleColFunction with TimestampCol